...
def artist(id):
    ...
    if 'images' not in artist.keys(): return None
    if artist['images']:
    ...
    # predict heart - rate
    model_name = 'cnn'
    if len(os.listdir("C:\\Users\\stree\\Desktop\\Web Development\\music recommender-final\\music recommender-final\\audio downloaded")) > 0:

        music = os.listdir("C:\\Users\\stree\\Desktop\\Web Development\\music recommender-final\\music recommender-final\\audio downloaded")[-1]
        path_folder = "C:\\Users\\stree\\Desktop\\Web Development\\music recommender-final\\music recommender-final\\audio downloaded"+ "\\" + music
